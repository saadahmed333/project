...
function First() {
  ...
  <div class="container  py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full  lg:pr-10 lg:py-6 mt-[50px] lg:mb-0">
      ...
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={bg} />
    </div>
  </div>
</section>
    )
